...
namespace DroneWebsite
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHostedService<NewsApiClientService>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Drones Articles API", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Drones Articles API V1");
